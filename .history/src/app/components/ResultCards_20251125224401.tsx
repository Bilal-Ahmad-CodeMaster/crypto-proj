    ...
    return (
        <div className="mb-3 rounded-lg border border-gray-200 bg-white hover:shadow-sm transition-all">
            <div className="flex">
                ...
                <div className={`w-56 p-2 text-white relative ${positive ? 'bg-linear-to-br from-green-600 to-green-700' : 'bg-linear-to-br from-red-500 to-red-600'}`}>
                    <div className="text-xs font-medium bg-[#258C66] inline-block px-3 py-1 rounded-r-full mb-3 absolute top-0 left-0 ${positive ? 'bg-linear-to-br from-green-600 to-green-700' : 'bg-linear-to-br from-red-500 to-red-600'}">{title}</div>
