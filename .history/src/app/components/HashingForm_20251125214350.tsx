    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-8 border-b border-gray-100 flex items-center justify-center">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center p-4">
                    <img
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 text-center py-4 text-sm text-gray-600 border-b border-gray-100">
                Calculated for
