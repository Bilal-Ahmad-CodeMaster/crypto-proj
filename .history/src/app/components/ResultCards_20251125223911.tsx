    ...
    return (
        <div className="mb-3 rounded-lg border border-gray-200 bg-white hover:shadow-sm transition-all">
            <div className="flex">
                ...
                <div className={`w-1/3 p-4 rounded-l-lg ${positive ? 'bg-[#3FB488] border-r border-green-200' : 'bg-[#F15C5C] border-r border-red-200'}`}>
                    ...
                    <div className={`text-2xl font-bold mb-1 text-white`}>{money}</div>
                    <div className={`text-xs text-white`}>Pool Fee {poolFee}</div>
                </div>
