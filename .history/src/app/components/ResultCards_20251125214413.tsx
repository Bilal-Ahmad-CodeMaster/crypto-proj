...
function StatRow({ title, money, mined, powerCost, positive = true }: StatRowProps) {
    return (
        <div className="mb-4 rounded-xl overflow-hidden flex border border-gray-200 bg-white hover:shadow-md transition-shadow">
            <div className={`w-56 p-6 text-white ${positive ? 'bg-gradient-to-br from-green-600 to-green-700' : 'bg-gradient-to-br from-red-500 to-red-600'}`}>
    ...
    return (
        <div>
            <div className="grid grid-cols-2 gap-6 mb-8">
                <div className={`rounded-2xl p-8 ${positive ? 'bg-gradient-to-br from-green-50 to-green-100 border border-green-200' : 'bg-gradient-to-br from-red-50 to-red-100 border border-red-200'}`}>
