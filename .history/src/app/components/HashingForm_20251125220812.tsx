        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-3 space-y-3">
                <div>
                    ...
                    <div className="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2  transition-all">
                        <input
                            type="number"
                            defaultValue={1}
                            className="flex-1 px-3 py-2 outline-none bg-white"
                        />
                        <select className="px-3 py-2 bg-gray-50 border-l border-gray-300 text-gray-700">
                            <option>H/s</option>
                            <option>KH/s</option>
                            <option>MH/s</option>
                            <option>GH/s</option>
